...
pub(crate) fn register_offload<'ll>(cx: &CodegenCx<'ll, '_>) {
    ...
    a.call(reg_lib_decl, None, None, register_lib, ReturnSlot::Direct, &[omp_descriptor], None, None);
    ...
    let mut a = Builder::build(cx, bb);
    a.call(reg_lib_decl, None, None, unregister_lib, ReturnSlot::Direct, &[omp_descriptor], None, None);
    a.ret_void();
